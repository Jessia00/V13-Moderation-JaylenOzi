...
module.exports = async (message) => {
  ...
  const embed = new MessageEmbed().setFooter({ text: `Created By Wasley ❤️`}).setColor(message.member.displayHexColor).setAuthor({ name: message.member.displayName, iconURL: message.author.avatarURL({ dynamic: true })});
