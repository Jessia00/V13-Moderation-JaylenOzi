...
moment.locale("tr");
    ...
    let iltifatlar = [
      ...
      "Acer senden mesaj bekliyor :)",
      "Snow tatlı Annenle Oyun Oynamak İstiyor bebegimm",
      " selam söyledi sana.",
      "Acer selam söyledi sana.",
      " yanına gelmek için uçak bileti almış benden duymuş olma.",
      "Acer yanına gelmek için otobüs bileti almış benden duymuş olma.",
